...
function Navbar({ map }) {
  ...
  return (
    <div className='w-full h-[62px] px-10 py-3 bg-white border-b border-gray-100 items-center flex justify-between relative'>
        {!map && <div className='2xl:w-[460px] w-[60%] flex flex-row'>
            <input className="w-full h-[38px] px-4 py-[13px] rounded-tl-[10px] rounded-bl-[10px] border border-zinc-200 justify-start items-center gap-2.5 inline-flex placeholder:text-gray-300 text-sm font-normal font-rubik leading-tight" placeholder='Search tracking number' type='text' />
