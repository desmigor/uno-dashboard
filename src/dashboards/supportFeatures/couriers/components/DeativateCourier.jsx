...
import { fetchGroupDetailsAction, updateCourierAction, updateGroupAction } from '../../../../redux/actions/fetchCouriersAction';
import { handleupdateCustomer } from '../../../../redux/actions/fetchCustomersAction';

const DeactivateCourierModal = ({ isOpen, setIsOpen, id, text, item }) => {
...
export default DeactivateCourierModal